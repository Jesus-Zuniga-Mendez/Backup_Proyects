    ...
    class Principal{
        public:
            ...
            void Menu(){
                ...
                cout << "   4: Ingresar una figura distinta con N cantidad de lados "<<FORMATO_BOLD_EFFECT<<"(EN Construccion...)" << endl;
                cout << FORMATO_ANSI_COLOR_RESET;
                cout << "   5: Manipular figuras"<<FORMATO_BOLD_EFFECT<<"(EN Construccion...)" << endl;
                cout << FORMATO_ANSI_COLOR_RESET;
                cout << "   0: Salir" << endl;
            }

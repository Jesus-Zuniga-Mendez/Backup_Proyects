 ...
 */
triangulo::triangulo(const triangulo& f){
 ...
 * @param f es un objeto
 */
Equilatero::Equilatero(const Equilatero& f){
    this->puntos = f.puntos;
    this->area = f.area;
    this->perimetrofig = f.perimetrofig;
    this->nombre = f.nombre;
...
double Equilatero::superficie(){
  return ((sqrt(3)/4) * pow(this->lado1,2));
}
 ...
 * @param f es un objeto
 */
Escaleno::Escaleno(const Escaleno& f){
    this->puntos = f.puntos;
    this->area = f.area;
    this->perimetrofig = f.perimetrofig;
    this->nombre = f.nombre;
 ...
 * @param f es un objeto
 */
Isosceles::Isosceles(const Isosceles& f){
    this->puntos = f.puntos;
    this->area = f.area;
    this->perimetrofig = f.perimetrofig;
    this->nombre = f.nombre;

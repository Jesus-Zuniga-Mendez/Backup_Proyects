...
typedef struct {
    ...
    U  I1036;
    U  I1037;
    HsimSignalMonitor  * I1038;
    RP  I1039;
    RmaTimeStamp64  I1040;
    U  I1041;
    RmaTimeStamp64  I1042;
    U  I1043;
    UB  I1044 :1;
    UB  I1045 :1;
    UB  I1046 :1;
...
typedef struct {
    U  I736;
    U  I744;
    RmaThreadSchedCompiledLoads  * I1072;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    U  I1149 :1;
    U  I944 :9;
    RmaSeqPrimOutputOnClkOpt  I1151;
    RmaSeqPrimOutputEblkData  I1155;
...
struct dummyq_struct {
    ...
    struct futq * I1259;
    struct futq * I1260;
    struct sched_table * I1261;
    struct futq_info * I1263;
    struct futq_info * I1265;
    U  I1266;
    U  I1267;
    U  I1268;
    U  I1269;
    ...
    EBLK  * I1322;
    int I1323;
    struct vcs_globals_t * I1324;
    U  I1326;
    clock_struct  I1327;
    unsigned long long I1328;
    EBLK  * I1329;
    EBLK  * I1330;
    void * I1331;
...
void  hs_0_M_2_21__simv_daidir (UB  * pcode, vec32  * I1065, U  I955);
void  hs_0_M_2_0__simv_daidir (UB  * pcode, vec32  * I1065, U  I955);
void  hs_0_M_2_5__simv_daidir (UB  * pcode, U  I955);
void  hs_0_M_3_0__simv_daidir (UB  * pcode, vec32  * I1065, U  I955);
...
void  hsG_0__0 (struct dummyq_struct * I1359, EBLK  * I1354, U  I707);
#ifdef __cplusplus
}
#endif
